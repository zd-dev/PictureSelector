...
import com.selector.picture.ui.adapter.PreviewPhotosAdapter;
...
//        }
    ...
    private void toggleSelector() {
        if (photos.get(lastPosition).selected) {
            ivSelector.setImageResource(R.drawable.icon_image_checked);
            if (!Result.isEmpty()) {
            ...
            ivSelector.setImageResource(R.drawable.shap_icon_pre_un_check);
        }
