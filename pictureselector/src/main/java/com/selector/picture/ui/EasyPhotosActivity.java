...
import com.selector.picture.constant.Key;
import com.selector.picture.entity.AlbumModel;
...
import com.selector.picture.utils.ColorUtils;
import com.selector.picture.utils.PermissionUtil;
import com.selector.picture.utils.SettingsUtils;
import com.selector.picture.utils.StringUtils;
import com.selector.picture.utils.SystemUtils;
import com.selector.picture.utils.UriUtils;
...
public class EasyPhotosActivity extends AppCompatActivity implements AlbumItemsAdapter.OnClickListener,
  PhotosAdapter.OnClickListener, View.OnClickListener {
...
//        super.onActivityResult(requestCode, resultCode, data);
    ...
    private void initView() {
        ...
        initAlbumItems();
        shouldShowMenuDone();
        setClick(tvAlbumItems, rootViewAlbumItems, tvDone, ivOriginal, tvPreview, ivCamera);
    ...
    private void hideActionBar() {
        ...
        StatusBarUtil.setTranslucentForImageViewInFragment(this, llTop);
    ...
    private void processOriginalMenu() {
        if (Setting.selectedOriginal) {
            ivOriginal.setImageResource(R.drawable.icon_image_checked);
        } else {
            if (Setting.originalMenuUsable) {
                ivOriginal.setImageResource(R.drawable.shap_icon_pre_un_check);
            } else {
                ivOriginal.setImageResource(R.drawable.shap_icon_pre_un_check);
            }
        }
